  ...
  return (
    <section className="portfolio">
      ...
      <ul className="portfolio__projects">
        ...
        <li className="portfolio__project"><a href="https://mesto.nomoreparties.sbs" className="portfolio__link link" target="_blanck" rel="noreferrer">Single-page app <span className="portfolio__link-arrow">&#8599;</span></a></li>
      </ul>
    </section>
  );
};
